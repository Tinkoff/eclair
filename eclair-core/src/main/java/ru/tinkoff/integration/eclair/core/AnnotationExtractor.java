...
import static ru.tinkoff.integration.eclair.core.AnnotationAttribute.PRINTER;
...
public final class AnnotationExtractor {
    ...
    private <T extends Annotation> Predicate<T> getLoggerPredicate(Set<?> loggers) {
        return annotation -> loggers.contains(AnnotationAttribute.LOGGER.extract(annotation));
    }
