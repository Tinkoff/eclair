 ...
 */
public class LogsValidatorTest {

    private Method method;

    @Before
    public void init() throws NoSuchMethodException {
        method = LogsValidatorTest.class.getMethod("init");
    }
    ...
    public void isTransitive() {
        ...
        LogsValidator logsValidator = new LogsValidator(loggerNames, logValidator);
        Log log = synthesizeAnnotation(Log.class);
        Set<Log> annotations = singleton(log);
        // when
        logsValidator.validate(method, annotations);
        // then
