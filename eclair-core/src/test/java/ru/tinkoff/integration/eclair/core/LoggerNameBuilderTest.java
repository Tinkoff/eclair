...
public class LoggerNameBuilderTest {
    ...
    public void buildOuter() throws NoSuchMethodException {
        ...
        // then
        assertThat(name, is("ru.tinkoff.integration.eclair.core.Outer.method"));
    }
    ...
    public void buildNested() throws NoSuchMethodException {
        ...
        String name = loggerNameBuilder.build(method);
        // then
        assertThat(name, is("ru.tinkoff.integration.eclair.core.LoggerNameBuilderTest$Nested.method"));
    }
    ...
    public void buildByStacktrace() {
        ...
        // then
        assertThat(name, is("ru.tinkoff.integration.eclair.core.LoggerNameBuilderTest.buildByStacktrace"));
    }
}
